...
const Hero = () => {
  return (
    <div className=" lg:max-w-7xl lg:ml-32 flex lg:flex-row flex-col lg:pl-0  gap-x-16 font-doto">
      <div className="flex flex-col gap-y-5 lg:pt-0 items-center lg:items-start">
        <img className="flex lg:hidden w-1/2 rounded-full pt-10 lg:pt-0" src={Me} alt="" />   
        <h1 className="lg:text-5xl text-3xl font-black">Hi There</h1>
        <h1 className="lg:text-7xl text-4xl font-black">
          I'm <span className="text-red-500">Tejas D M</span>
        </h1>
        <p className="lg:text-7xl text-4xl font-black lg:text-start text-center">I am a Web Developer</p>
